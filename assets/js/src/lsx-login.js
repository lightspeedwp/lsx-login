...
jQuery(document).ready(function($) {
	...
	if (('undefined' === typeof jQuery().dropdown)) {
		jQuery.ajax({
			url: lsx_login_params.theme_url + 'assets/js/vendor/bootstrap.dropdown.js',
			dataType: "script",
			cache: true
		});
	}
	...
	if (('undefined' === typeof jQuery().modal)) {
		jQuery.ajax({
			url: lsx_login_params.theme_url + 'assets/js/vendor/bootstrap.modal.js',
			dataType: "script",
			cache: true
		});
	}
	...
	if (('undefined' === typeof jQuery().tab)) {
		jQuery.ajax({
			url: lsx_login_params.theme_url + 'assets/js/vendor/bootstrap.tab.js',
			dataType: "script",
			cache: true
		});
	}
